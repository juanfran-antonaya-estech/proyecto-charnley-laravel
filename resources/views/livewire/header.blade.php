<div class="h-15 bg-base-300 flex justify-between items-center px-4 relative">
    ...
    <div>
        <p>Bienvenido/a, <span class="font-bold">{{ $user->name }}</span>
            @if( Route::has('web.settings') )
            <a class="btn btn-sm btn-primary" href="{{ route('web.settings') }}" tooltip="Configuración">
